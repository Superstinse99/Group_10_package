...
The package can be installed using either of these methods: -
...
Function 1: The first function in the package generates a random
sequence of bases in the desired length.
...
Function 3: The third function in the package takes the DNA
sequence, indicating start of the sequence at one, and then reads it
...
Function 5: The fifth function in the package is plots the frequency
...
3. Discuss why it is a good idea to limit the number of dependencies your package has. When can’t it always be avoided? - Chunxu
...
* Efficiency: Having fewer dependencies can help your package run more efficiently and save time while installing and loading.
